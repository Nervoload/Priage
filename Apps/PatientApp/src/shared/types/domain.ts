...
export interface DemoVisitChecklistItem {
  id: string;
  label: string;
  description: string;
}

export interface CareTeamDisplayMember {
  userId: number;
  name: string;
  role: string;
...
export interface EncounterDraftAttachment {
  id: string;
  name: string;
  note: string;
  tint: string;
...
export interface EncounterDraftState {
  ...
  attachments: EncounterDraftAttachment[];
}
...
export interface DemoScenarioDefinition {
  ...
  hospitalName: string;
  hospitalSlug: string;
  encounterStatusPreview?: EncounterStatus;
  authEmail?: string;
  authPassword?: string;
  guestStartDefaults?: {
    firstName: string;
